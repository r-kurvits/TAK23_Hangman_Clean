...
class View(Tk):
    ...
    def create_buttons(self):
        ...
        new.grid(row=0, column=0, padx=5, pady=5, sticky=EW)
        cancel.grid(row=0, column=2, padx=5, pady=5, sticky=EW)
        send.grid(row=1, column=2, padx=5, pady=5, sticky=EW)
